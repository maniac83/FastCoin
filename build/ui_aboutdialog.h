...
""));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About GraniteCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>GraniteCoin</b> version", 0));
