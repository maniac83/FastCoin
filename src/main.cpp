...
uint256 hashGenesisBlock("0x0000045829c0ff63f18b3891b721a3550195bf9444e68be615375e069eb5ce75");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // CoconutCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "CoconutCoin Signed Message:\n";
...
{
    // CoconutCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	int bonusRewardPool = 100000;					// jackpot for occasional blocks
	...
	{
		nSubsidy = ((bonusRewardPool * 0.3) * COIN);
	}
	...
	{
		nSubsidy = ((bonusRewardPool * 0.4) * COIN);
	}
	else
	{
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // CoconutCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
unsigned int GetNextWorkRequired_V3(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // thanks to RealSolid & WDC for the basis of this code, modified by Mammix2 for Coconutcoin
...
{
    // CoconutCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000001bfea18deacc77f45dc526cb587dfb7b1c47b8540352fc7856b30a748f4");
    }
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "01-07-2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1404231988;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1210138;

        if (fTestNet)
        {
            block.nTime    = 1404232589;
            block.nNonce   = 976243;
        }
	...
	/*if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xa6fb39d324683f1a3c86d47f62d9d6f2a5ec97b5c88b154714750e9acf63d257"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // CoconutCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CoconutCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CoconutCoinMiner : ProcessBlock, block not accepted");
    }
