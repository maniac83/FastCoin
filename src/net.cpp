...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CoconutCoin " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    {"testnet-seed.testcoin.pl", "testnet-seed.testcoin.pl"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CoconutCoin is probably already running."), addrBind.ToString().c_str());
        else
